...
//        let unpaidOrders = weeklyOrders.values.filter { !$0.isPaid }
...
//                DispatchQueue.main.async {
//                    self?.showAlert(title: "Error", message: "Failed to mark week as paid. Please try again.")
//                }
//            }
//        }
    }
...
//        guard let order = weeklyOrders.values.first(where: { $0.id.hashValue == sender.tag }) else { return }
//        
